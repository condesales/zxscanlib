...
public class ZXDecoder implements BarcodeDecoder {
    ...
    final static Collection<BarcodeFormat> ONE_D_FORMATS =
            EnumSet.of(
    ...
    public String decode(final byte[] image, final int width, final int height) {
        Result result = null;
        PlanarRotatedYUVLuminanceSource source = new PlanarRotatedYUVLuminanceSource(image, width, height, 0, 0, width, height, true);
